...
or to see it at a larger scale, look here [`custos-math`](https://github.com/elftausend/custos-math) (outdated) or here [`sliced`](https://github.com/elftausend/sliced) (for automatic diff examples).
