...
extern "C" {
    ...
    pub fn cblas_sgemm(
        order: Order, trans_a: Transpose, 
        trans_b: Transpose, m: usize, n: usize, 
        k: usize, alpha: f32, a: *const f32,
        lda: usize, b: *const f32, ldb: usize,
    ...
    pub fn cblas_dgemm(
        order: Order, trans_a: Transpose, 
        trans_b: Transpose, m: usize, n: usize, 
        k: usize, alpha: f64, a: *const f64,
        lda: usize, b: *const f64, ldb: usize,
