...
pub struct Cached2<Mods, CacheType = FastCache> {
    pd: PhantomData<Mods>,
    cache_type: PhantomData<CacheType>,
}

impl<CacheType, Mods: WrappedData, SD: Device> WrappedData for CachedModule2<Mods, SD, CacheType> {
...
impl<'a, CacheType, Mods: Module<'a, D>, D: Device + 'a> Module<'a, D> for Cached2<Mods, CacheType>
where
    CacheType: Default,
{
    type Module = CachedModule2<Mods::Module, D, CacheType>;
...
// TODO: could remove D generic and therefore CachedModule
pub struct CachedModule2<Mods, D: Device, CacheType = FastCache> {
    pub modules: Mods,
...
impl<CacheType, Mods: Setup<NewDev>, D: Device, NewDev> Setup<NewDev>
    for CachedModule2<Mods, D, CacheType>
{
    #[inline]
...
impl<CacheType, SD: Device, Mods: AddOperation> AddOperation for CachedModule2<Mods, SD, CacheType> {
    #[inline]
...
impl<CacheType, T, Mods: SetOpHint<T>, SD: Device> SetOpHint<T>
    for CachedModule2<Mods, SD, CacheType>
{
    #[inline]
...
impl<CacheType, Mods: OnDropBuffer, SD: Device> OnDropBuffer for CachedModule2<Mods, SD, CacheType> {
    #[inline]
...
impl<CacheType, T, Mods, D, SimpleDevice, S: Shape> Retrieve<D, T, S>
    for CachedModule2<Mods, SimpleDevice, CacheType>
where
    T: Unit + 'static,
    Mods: Retrieve<D, T, S>,
...
impl<CacheType, Mods, SD: Device> Cursor for CachedModule2<Mods, SD, CacheType> {
    #[inline]
...
impl<CacheType, CurrentMods, SD: Device> AddLayer<CurrentMods, SD> for Cached2<(), CacheType> {
    type Wrapped = crate::CachedModule2<CurrentMods, SD>;
...
impl<CacheType, Mods, SD: Device> RemoveLayer<Mods> for CachedModule2<Mods, SD, CacheType> {
    #[inline]
...
impl<CacheType, Mods: AddGradFn, D: Device> AddGradFn for CachedModule2<Mods, D, CacheType> {
    #[inline]
...
#[cfg(feature = "graph")]
impl<Mods: Optimize, SD: Device> Optimize for CachedModule2<Mods, SD, FastCache> {
...
impl<CacheType, Mods: OnDropBuffer, D: Device> CachedBuffers for CachedModule2<Mods, D, CacheType> {
    #[inline]
...
impl<CacheType, Mods, D, T, S, SD> ReplaceBuf<T, D, S> for CachedModule2<Mods, SD, CacheType>
where
    T: Unit,
...
impl<CacheType, Mods, D: Device> HasModules for CachedModule2<Mods, D, CacheType> {
    type Mods = Mods;
...
mod tests {
    ...
    fn test_cached_return_retrieve() {
        // invalid!
        let _x = {
            let device = CPU::<Cached2<Base>>::new();
    ...
    fn test_add_cached_layer() {
        ...
        let device = device.add_layer::<Cached2<()>>();
