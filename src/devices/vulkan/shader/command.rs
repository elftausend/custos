use ash::{Device, vk::{self, CommandPool, CommandBuffer}, prelude::VkResult};
...
pub fn create_command_buffer(device: &Device, command_pool: CommandPool) -> VkResult<CommandBuffer> {
